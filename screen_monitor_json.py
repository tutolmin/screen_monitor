...
При выборе варианта ответа опирайся в первую очередь на информацию из приложенного к запросу файла. \
...
- Тема; \
- Описание задачи; \
- Несколько вариантов ответов, каждый с новой строки или пронумерованные 1, 2, 3, 4, 5 и т.д. или A, B, C, D и т.д. \
...
Ограничения: \
- В ответах не может быть более семи вариантов. Если ты распознал больше семи вариантов ответа, выведи {\"0\":\"Ошибка\"} \
